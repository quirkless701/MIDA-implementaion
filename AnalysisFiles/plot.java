...
/*Goal: Implementation and comparsion of McAfee double auction and posted price mechanism for multi unit item. 
...
public class plot {
    ...
    //Buyers payment, Sellers payment and Total payment in Crowd Sourcing Algorithm 1
    static double buyers1payment;
    static double sellers1payment;
    static double total1payment;

    //Buyers payment, Sellers payment and Total payment in Crowd Sourcing Algorithm 2
    ...
    public static void main(String[] args) {
        ...
        //The b values carry number of buyers in both groups of Crowd Sourcing Algorithms
        int b1=0; //for Algorithm 1
        int b2=0; //for Algorithm 1
        int b3=0; //for Algorithm 2
        //MCAFEE
        ...
        //The below Lists are for storing group 1 and group 2 values for Crowd Sourcing Algorithm 1
        ArrayList<Double> grpA=new ArrayList<Double>();
        ArrayList<Double> grpB=new ArrayList<Double>();

        //The below List is for storing group values for Crowd Sourced Algorithm 2
        ...
        for(int i=0;i<300;i++){    
            double randomValue = Math.round((ran.nextGaussian() * 5 + 15));
    ...
    //The below method for calculating the equivalent amount of group in CS algorithm
    public static double calcequi(ArrayList<Double> grp,int b){
       ...
       while(demand>=supply){
        ...
        System.out.println("Equivalent price of group is "+equiPrice);
        return equiPrice;
    }

    //The below method is for pairing buyers and sellers in Crowd Sourcing Algorithm
    ...
    public static void finstep2(ArrayList<Double> grp,int b,double equip){
        ...
        //Comparing the equivalent price with buyers
        for(int i=0;i<b;i++){
            if(grp.get(i)>=equip)
            {
                System.out.println("Buyer "+i+" is ready to buy for "+grp.get(i));
        ...
        //Comparing the equivalent price with sellers
        for(int i=b;i<grp.size();i++){
            if(grp.get(i)<=equip){
                System.out.println("Seller "+i+" is ready to sell for "+grp.get(i));
                numofsellers++;
    ...
    public static void plotting(){
        try{
            File file =new File("normallargedata1.txt");
